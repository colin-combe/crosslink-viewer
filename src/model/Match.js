...
function Match(pep1_protIDs, pep1_positions, pep2_protIDs, pep2_positions,
        ...
        //the following attributes are optional (also pep1_positions, pep2_positions and score in preceeding)
         pepSeq1, pepSeq2, autovalidated, validated, rejected, dataSetId, manuallyDashed){
    ...
    if (manuallyDashed && manuallyDashed.toLowerCase().trim() == "true") {
        this.manuallyDashed = true;
    }
...
Match.prototype.isAmbig = function() {
    if (this.residueLinks.length > 1 || this.manuallyDashed) {
        return true;
    }
    return false;
}
