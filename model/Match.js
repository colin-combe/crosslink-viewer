function Match(pep1_protIDs, pep1_positions, pep2_protIDs, pep2_positions, id, meta, xlvController, linkPos1, linkPos2, pep1_seq, pep2_seq) {
        ...
        for (var j = 0; j < pep2_positions.length; j++) {
            ...
            if (link === undefined) {
                if (fromProt === undefined || toProt === undefined) {
                    alert("Something has gone wrong; a link has been added before a protein it links to. " + p1ID + "-" + p2ID);
                }
